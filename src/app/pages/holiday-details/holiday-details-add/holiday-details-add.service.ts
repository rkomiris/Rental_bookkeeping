...
export class HolidayDetailsAddService {
  constructor(private http:Http) { }
  private URL: string = environment.API_HOST;
  load_holidayDetailsAdd():Observable<{}>{
    ...
    return this.http.post(this.URL+"/holiday/add",{ screenJson:{"screenId": 25,  "subScreenId": 48}}		       
    , headeroptions);
  }
