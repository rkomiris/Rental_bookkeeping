...
@Component({
  selector: 'app-widgets-add',
  templateUrl: './widgets-add.component.html',
  // styleUrls: ['./widgets-add.component.css'],
  styleUrls: ['./widgets-add-srmav.component.css'],
  // changeDetection: ChangeDetectionStrategy.OnPush
})
export class WidgetsAddComponent implements OnInit, AfterViewInit {
  saveForm: FormGroup;
  count: any = 1;
  ...
  constructor(
    ...
    private widgetsAddService: WidgetsAddService,
  ...
  call() {
    this.widgetsAddService.addscreen().subscribe(data => {
      ...
      // if (selectGetData.authSuccesObject.screenFieldDisplayVoList !== undefined) {
  ...
  onSubmit(event) {
    if (this.saveForm.valid) {
      ...
      if (this.saveForm.value.widgetDetailVoList[0].widgetDetailAttPath !== null && this.saveForm.value.widgetDetailVoList[0].widgetDetailAttPath !== undefined && this.saveForm.value.widgetDetailVoList[0].widgetDetailAttPath !== '') {
