...
@Component({
  selector: 'app-widgets-admin-modify',
  templateUrl: './widgets-admin-modify.component.html',
  // styleUrls: ['./widgets-admin-modify.component.css'],
  styleUrls: ['./widgets-admin-modify-srmav.component.css'],
  // changeDetection: ChangeDetectionStrategy.OnPush
})
export class WidgetsAdminModifyComponent
  ...
  ngOnInit() {
    ...
    // this.widgetsModifyService.getModifyData().subscribe(data => {
  ...
  onSubmit(event) {
    if (this.saveForm.valid) {
      ...
      if (
        this.saveForm.value.widgetDetailVoList[0].widgetDetailPicPath !== null &&
        this.saveForm.value.widgetDetailVoList[0].widgetDetailPicPath !== undefined &&
  ...
  mappingRowObject(data) {
    this.data = data;
    if (data.widgetDetailPicturePath !== null) {
    ...
    // this.picName = data.widgetDetailAttPath;
    // this.attName = data.widgetDetailPicPath;
    let control = this.saveForm.get('widgetDetailVoList') as FormArray;
    let temp: any = {};
    for (let key in data) {
