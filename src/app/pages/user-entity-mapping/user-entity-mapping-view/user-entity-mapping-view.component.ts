...
@Component({
  selector: 'app-user-entity-mapping-view',
  templateUrl: './user-entity-mapping-view.component.html',
  styleUrls: ['./user-entity-mapping-view.component.css']
})
export class UserEntityMappingViewComponent implements OnInit {
